  ...
  return (
    <div className='z-10 fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center item-center'>
        <div className='m-auto w-[30rem] h-[20rem] relative pt-16 px-10 rounded-3xl bg-[#CCF2F4]  '>
          <h1 className='text-3xl font-semibold mb-8 text-left'>Create new group</h1>
        <img className='w-[2rem] hover:brightness-75 active:brightness-50 absolute top-10 right-10 transition ease-in-out delay-75 cursor-pointer'
        onClick={onClose}
        src='/image/cross.png'/>
